...
function run(Player)
	...
	local PositionPhysicsMultiply = 7.5
	local RotationPhysicsMultiply = 2
	...
	function Function.ApplyUV(ObjectInstance, Character, Extra, Data)
		...
		if objectName:find("uv") or objectName:find("texture") then
			...
			if objectName:find("shirt") or objectName:find("boob") or objectName:find("chest") or objectName:find("torso") or objectName:find("arm") then
				ObjectInstance.TextureID = Extra.Shirt.ShirtTemplate
			end
			if objectName:find("pant") or objectName:find("hip") or objectName:find("base") or objectName:find("leg") then
